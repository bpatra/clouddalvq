...
//        private TimeSpan _timeBetweenTwoLogs = new TimeSpan(0, 0, 1, 0);
...
//                            try
//                            {
//                                this.PushVersion(prototypesName, prototypesToPush);

//                                //Informing the merging service that a new version for this worker is available.
//                                Put(prototypesName, averagingQueueName);
//                                writeSuccessCount++;
//                            }
//                            catch (Exception e)
//                            {
...
//                var oldPrototypes = localPrototypes.Clone();
...
//                                processor.LocalMerge(ref localPrototypes, oldPrototypes, sharedPrototypes, settings.LocalMergeRatio);
//                                oldPrototypes = localPrototypes.Clone();
//                            }
//                        }
//                    }
//                }
...
//        protected virtual void PushVersion(WPrototypesName prototypesName, WPrototypes prototypesToPush)
//        {
