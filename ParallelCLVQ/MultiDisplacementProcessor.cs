...
{
    /// <summary>
    /// Handles concurrent CLVQ execution with displacement reducing logic.
    /// </summary>
    public class MultiDisplacementProcessor
    {
        ...
        public MultiDisplacementProcessor(Settings settings)
        {
